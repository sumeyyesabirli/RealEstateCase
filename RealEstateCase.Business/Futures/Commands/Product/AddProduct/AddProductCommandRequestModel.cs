...
{
    public class AddProductCommandRequestModel : IRequest<BaseResponseModel<bool>>
    {
        ...
        public ProductDetailsCommandRequestModel ProductDetails { get; set; }
    }

    public class ProductDetailsCommandRequestModel
    {
        public string Title { get; set; }
        public string Description { get; set; }
